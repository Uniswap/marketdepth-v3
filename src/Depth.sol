...
contract Depth is IDepth {
    ...
    ///@dev For calculating different depth configuations on the same pool, we can skip initializing the pool variables by ordering the repeated pools adjacent.
